...
from app.schemas.video import VideoCreate, VideoStatsCreate
from app.schemas.channel import ChannelCreate, ChannelStatsCreate
...
def fetch_video_info(video_id: str):
    ...
    return parse_video_info(video_data)
...
def fetch_channel_info(channel_id: str):
    ...
    return parse_channel_info(channel_data)
